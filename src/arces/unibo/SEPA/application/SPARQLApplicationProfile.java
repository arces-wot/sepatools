...
public class SPARQLApplicationProfile {	
	...
	private HashMap<String,SPARQLQuerySolution> updateBindingsMap = new HashMap<>();
	private HashMap<String,SPARQLQuerySolution> subscribeBindingsMap = new HashMap<>();
	...
	public class Parameters {
		...
		private int subscribePort = 7980;
	...
	public SPARQLQuerySolution subscribeBindings(String id) {
		return subscribeBindingsMap.get(id);
	}
	
	public SPARQLQuerySolution updateBindings(String id) {
	...
	public synchronized boolean load(String fileName){
		...
		for (Element node : nodes) {
			...
			HashMap<String,SPARQLQuerySolution> bindingsMap = null;
