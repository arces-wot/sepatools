...
public class SSLSecurityManager {
	...
	public class SEPAWssConfigurator extends SslEngineConfigurator {
		...
		/**
		 * Instantiates a new SEPA WSS configurator.
		 *
		 ...
		 */
		//For client side allows to enable/disable hostname verification
		public SEPAWssConfigurator(SSLContext sslContext,boolean client,boolean hostVerificationEnabled,HostnameVerifier hostnameVerifier) {
		 ...
		 */
		// Allows to specify client or server
		public SEPAWssConfigurator(SSLContext sslContext,boolean client) {
			super(sslContext,client,false,false);
		}
	}
	 ...
	 * @param hostnameVerifier allows to specify a custom hostname verifier. If null, the default hostname verification is used (based on the SSL certificate)
	 */
	public SSLSecurityManager(String keystoreFileName,String keystorePwd,String keyAlias,String keyPwd,String certificate,boolean client,boolean hostVerificationEnabled,HostnameVerifier hostnameVerifier)  {
	...
	/**
	 * Gets the WSS configurator.
	 *
	 * @return the WSS configurator
	 */
